...
@section('content')
    ...
    <section>
        <div class="container mt-4" id="container">
            <h3><i class="fa fa-plus" aria-hidden="true"></i> Nuevo item</h3>

            {{ Form::open(['id' => 'formItem', 'enctype'=>'multipart/form-data', 'class'=>'small', 'data-url' => url('item')]) }}
            <div class="row mt-4">
                ...
                <div class="col-12  col-md-6 col-lg-3">
                    ...
                    <div id="field_item_min_stock" class="form-group">
                        ...
                        <span class="text-danger">*</span>
                        {!! Form::number('item_min_stock', 0, ['id'=>'item_min_stock', 'class'=>'form-control form-control-sm mousetrap', 'placeholder'=>'Stock mínimo del item', 'autocomplete'=>'off']) !!}
                        <div class="form-control-feedback"></div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-9 offset-lg-1">
                    ...
                    <div class="form-group mt-2 text-right">
                        ...
                        <a href="{{ url('/item') }}" class="btn btn-link btn-sm"><i class="fa fa-list-ol" aria-hidden="true"></i> Items</a>
                    </div>
                </div>
            </div>
            {{ Form::close() }}
